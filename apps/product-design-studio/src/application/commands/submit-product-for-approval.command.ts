...
export class SubmitProductForApprovalHandler
  implements ICommandHandler<SubmitProductForApprovalCommand, { status: string }>
{
  constructor(
  ...
  async execute(command: SubmitProductForApprovalCommand): Promise<{ status: string }> {
