...
@Entity({ name: 'tenant_profiles', schema: 'tenant_organization' })
...
@Entity({ name: 'service_entitlements', schema: 'tenant_organization' })
...
@Entity({ name: 'api_keys', schema: 'tenant_organization' })
